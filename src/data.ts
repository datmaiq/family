...
export async function getEvent(id: string) {
  return (await getRooms()).find((event) => event.id.toString() === id)!
}
  ...
  return [
    {
      ...
      name: 'P1',
      url: '/rooms/1000',
      location: '287C1 Ngô Gia Tự, TP Phan Rang Tháp Chàm, Ninh Thuận ',
      totalRevenue: '$102,552',
      totalRevenueChange: '+3.2%',
      totalDaysInContract: 365,
      totalDaysLeft: 50,
      electricBill: '100.000 VNĐ',
      ticketsSoldChange: '+8.1%',
      pageViews: '24,300',
      pageViewsChange: '-0.75%',
      status: 'Còn trống',
      imgUrl: '/rooms/p1.jpeg',
    ...
    },
    {
      ...
      totalDaysInContract: 365,
      totalDaysLeft: 50,
      electricBill: '200.000 VNĐ',
      ticketsSoldChange: '+8.1%',
      pageViews: '57,544',
      pageViewsChange: '-2.5%',
      status: 'Còn trống',
      imgUrl: '/rooms/p2.jpeg',
    ...
    },
    {
      ...
      totalDaysInContract: 365,
      totalDaysLeft: 70,
      electricBill: '548.000 VNĐ',
      ticketsSoldChange: '+8.1%',
      pageViews: '122,122',
      pageViewsChange: '-8.0%',
      status: 'Đã cho thuê',
      imgUrl: '/rooms/p3.jpeg',
    ...
    },
    {
      ...
      totalDaysInContract: 365,
      totalDaysLeft: 90,
      electricBill: '748.000 VNĐ',
      ticketsSoldChange: '+8.1%',
      pageViews: '9,000',
      pageViewsChange: '-0.15%',
      status: 'Còn trống',
      imgUrl: '/rooms/p4.jpeg',
